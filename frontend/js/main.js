...
function loadServices() {
    ...
    const services = [
        {
            icon: '🛣️',
            image: '/static/images/DJI_20250530162006_0002_V.jpg',
            title: 'Road Construction',
            description: 'Flexible pavements, road rehabilitation, drainage works, and asphalt surfacing.',
            link: '/services/#road'
        },
        {
            icon: '🚜',
            image: '/static/images/DJI_20250530162737_0039_V.jpg',
            title: 'Earth Works',
            description: 'Bulk earthmoving, excavations, stockpiling, and load & haul operations.',
            link: '/services/#earth'
        },
        {
            icon: '🏗️',
            image: '/static/images/DJI_20250529171556_0077_D.jpg',
            title: 'Building Works',
            description: 'Complex residential and industrial projects with world-class specifications.',
            link: '/services/#building'
        },
        {
            icon: '⛏️',
            image: '/static/images/DJI_20250529171427_0071_D.jpg',
            title: 'Contract Mining',
            description: 'Opencast chrome and coal mining with modern equipment fleet.',
